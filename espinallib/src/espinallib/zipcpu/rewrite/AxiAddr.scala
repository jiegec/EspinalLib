...
import spinal.lib.bus.amba4.axi.Axi4.burst.FIXED
import spinal.lib.bus.amba4.axi.Axi4.burst.INCR
import spinal.lib.bus.amba4.axi.Axi4.burst.RESERVED
import spinal.lib.bus.amba4.axi.Axi4.burst.WRAP

/** AXI4 burst transfer addr calculation
  *
  * ref: https://github.com/ZipCPU/wb2axip/blob/master/rtl/axi_addr.v blog post:
  * https://zipcpu.com/blog/2019/04/27/axi-addr.html standard: ARM IHI 0022E
